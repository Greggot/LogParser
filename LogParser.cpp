...
-data-"LOG"-server-client-save-".txt", где  data - метка о том, что в файле находятся только байты данных. Без неё в файле вся таблица
                                            server-client - метка нахождения в файле только определённых двух ID - сервера и клиента
