...
uint16_t ParserVolvo::countLength(uint8_t one, uint8_t two)
{
...
bool ParserVolvo::CheckFor_0x34(char* Input, byteString commandString, CommandIndex cmnd) 
{
...
bool ParserVolvo::CheckFor_0x36(byteString* commandString, CommandIndex cmnd)      
{
...
bool ParserVolvo::CheckFor_0x76 (byteString* responceString, CommandIndex cmnd)
{
    byteString* subResponceString = responceString + 1;
...
bool ParserVolvo::CheckFor_0x37 (char* Input, byteString commandString, CommandIndex cmnd)
{
...
byteString* ParserVolvo::FromTxtTobyteString(const char* Path, uint32_t& DataStringNumber)
{
...
int ParserVolvo::FromTxtToBin(const char* TxtPath, const char* BinPath)
{
